...
- [Array Methods in JS](#array-methods-in-js)
  - [Contents](#contents)
  - [Intro](#intro)
  ...
  - [Basic Looping/Iteration](#basic-loopingiteration)
...
This repo is to be additional resource to help students understand certain array methods in JS. We focus on array methods that iterates through the array ie forEach, map etc. I will provide example of some common issues that pop up while learning these methods. We will then go over the signature of the some of the most commonly used functions
...
3. To return or not to return. (Missing return statements)
   1. > We pretty much always need to do a return otherwise the default return is undefined. Exception is forEach which **ALWAYS** returns undefined
...
> These Array Methods are basically Loops. So lets comapre them with your everday for Loop
...
Reduce has an extra parameter, the accumulator. This is pretty much the magic behind reduce. This accumalator basically accumulates new information at every iteration. And at the end we return the accumulated value.

Reduce is a very powerful tool to have in your JS toolbox. It's pretty awesome.

The `function in the reduce file` basically prints out a summary of our team status. For now I will not go into too much detail about this. But if you have time take a look and see if you can understand what's going on. It returns a summary like this
